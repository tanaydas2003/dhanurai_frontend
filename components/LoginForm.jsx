...
//               <Button variant="outlined" color="primary" style={{ flexGrow: 1, marginRight: 8, borderColor: '#5726BF', color: '#5726BF' }}>
//                 <GoogleIcon sx={{ color: '#5726BF' }} />
//               </Button>
//               <Button variant="outlined" color="primary" style={{ flexGrow: 1, borderColor: '#5726BF', color: '#5726BF' }}>
